  ...
  return (
    <div className="min-h-dvh bg-paper text-ink">
      <div className="mx-auto flex min-h-dvh max-w-6xl">
        <aside className="hidden md:flex w-60 shrink-0 flex-col border-r border-line bg-navy text-cream p-5">
          <div className="mb-8">
        ...
        <div className="flex-1 min-w-0 flex flex-col pb-[calc(4.5rem+env(safe-area-inset-bottom))] md:pb-0">
          {children}
        </div>
      </div>

      <nav className="md:hidden fixed bottom-0 inset-x-0 z-30 bg-cream/95 backdrop-blur-md border-t border-line pb-[env(safe-area-inset-bottom)]">
      ...
      {!onboarded ? (
        <div className="fixed inset-0 z-40 bg-navy-deep/60 grid place-items-end md:place-items-center p-4">
